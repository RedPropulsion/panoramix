#define DT_DRV_COMPAT worldsemi_ws2812_gpio_stm32
...
struct gpio_dt_spec pin = GPIO_DT_SPEC_GET(DT_DRV_INST(0), gpios);
...
#define WS2812_STM32_DEFINE(idx)                                               \
  ...
  static const struct ws2812_stm32_config ws2812_stm32_##idx##_cfg = {         \
      ...
      .port =                                                                  \
          (GPIO_TypeDef *)DT_REG_ADDR(DT_PHANDLE(DT_DRV_INST(idx), gpios)),    \
      ...
      .cpu_mhz = DT_INST_PROP(idx, cpu_mhz),                                   \
                                                                               ...
                                                                               \
  DEVICE_DT_INST_DEFINE(idx, ws2812_stm32_init, NULL, NULL,                    \
                        &ws2812_stm32_##idx##_cfg, POST_KERNEL,                \
                        CONFIG_LED_STRIP_INIT_PRIORITY, &ws2812_stm32_api);
